...
MAC_IP        = "192.168.5.144" # change the ip if needed
...
# -------------------- Main Loop --------------------
while True:
    # moyenne des centres pour eviter l'incertitude
    #cx_sum = np.zeros(8400)
    #cy_sum = np.zeros(8400)
    ok, frame = cap.read()
